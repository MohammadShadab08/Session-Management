...
<body>
  ...
  <section id="hero">
        ...
        <!-- Slide 1 -->
        <div class="carousel-item active" style="background-image: url(assets/img/home.jpg)">
    ...
    <br><br><br><br><br>
        <!-- <h2 style="color:blue;"><strong><u>welcome to Meeting Sheduled App</u></strong></h2>  -->  
